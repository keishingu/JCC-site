...
export default function JournalHero() {
  return (
    <section style={{ position: 'relative', height: 380, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 56, top: 110, color: '#0a1628', maxWidth: 540 }}>
        <h1 style={{ margin: 0, fontSize: 64, letterSpacing: '.03em', fontWeight: 400, lineHeight: 1,
          fontFamily: '"Cormorant Garamond","Shippori Mincho B1",serif' }}>JOURNAL</h1>
        <div style={{ marginTop: 12, fontSize: 18, color: '#16263f',
          fontFamily: '"Shippori Mincho B1","Noto Serif JP",serif' }}>会誌・記録・思想</div>
        <div style={{ marginTop: 26, fontSize: 12.5, color: '#3d5070', lineHeight: 1.95, maxWidth: 380 }}>
          1958年から続く、<br/>
