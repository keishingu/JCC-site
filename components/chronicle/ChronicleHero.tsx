...
export default function ChronicleHero() {
  return (
    <section style={{ position: 'relative', height: 420, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 56, top: 130, color: 'var(--color-ink)', maxWidth: 540 }}>
        <h1 style={{ margin: 0, fontSize: 56, letterSpacing: '.04em', fontWeight: 500, lineHeight: 1,
          fontFamily: 'var(--font-en-sans)' }}>CHRONICLE</h1>
        <div style={{ marginTop: 14, fontSize: 18, color: 'var(--color-navy)',
          fontFamily: 'var(--font-jp)' }}>登攀記録アーカイブ</div>
        <div style={{ marginTop: 28, fontSize: 12.5, color: 'var(--color-slate)', lineHeight: 1.95, maxWidth: 460 }}>
