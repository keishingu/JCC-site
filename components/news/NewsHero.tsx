...
export default function NewsHero() {
  return (
    <section style={{ position: 'relative', height: 360, overflow: 'hidden' }}>
      ...
      <TopNav active="NEWS"/>
      <div style={{ position: 'absolute', left: 56, top: 88, color: '#0a1628' }}>
        <div style={{ fontSize: 11.5, letterSpacing: '.2em', color: '#3d5070',
          fontFamily: '"Cormorant Garamond","Shippori Mincho B1",serif' }}>NEWS</div>
        <h1 style={{ margin: '14px 0 12px', fontSize: 56, lineHeight: 1.1, fontWeight: 500,
          fontFamily: '"Shippori Mincho B1","Noto Serif JP",serif' }}>お知らせ・記録</h1>
        <div style={{ fontSize: 16, color: '#16263f',
          fontFamily: '"Shippori Mincho B1","Noto Serif JP",serif' }}>News &amp; Field Notes</div>
        <div style={{ marginTop: 22, fontSize: 12, color: '#3d5070', lineHeight: 1.95, maxWidth: 380 }}>
