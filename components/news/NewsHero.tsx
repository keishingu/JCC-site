  ...
  return (
    <section style={{ position: 'relative', height: 400, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 56, top: 110, color: 'var(--color-ink)', maxWidth: 540 }}>
        <h1 style={{ margin: 0, fontSize: 56, letterSpacing: '.04em', fontWeight: 500, lineHeight: 1, fontFamily: 'var(--font-en-sans)' }}>NEWS</h1>
        <div style={{ marginTop: 14, fontSize: 17, color: 'var(--color-navy)', fontFamily: 'var(--font-jp)' }}>お知らせ・記録</div>
