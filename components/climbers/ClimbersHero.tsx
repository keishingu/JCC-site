...
export default function ClimbersHero() {
  return (
    <section style={{ position: 'relative', height: 380, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 56, top: 110, color: '#0a1628', maxWidth: 580 }}>
        <h1 style={{ margin: 0, fontSize: 60, letterSpacing: '.04em', fontWeight: 500, lineHeight: 1,
          fontFamily: '"Cormorant Garamond","Shippori Mincho B1",serif' }}>CLIMBERS</h1>
        <div style={{ marginTop: 14, fontSize: 17, color: '#16263f',
          fontFamily: '"Shippori Mincho B1","Noto Serif JP",serif' }}>会員紹介</div>
        <div style={{ marginTop: 26, fontSize: 12, color: '#3d5070', lineHeight: 2.0, maxWidth: 520 }}>
