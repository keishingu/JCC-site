  ...
  return (
    <section style={{ padding: '24px 56px 80px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 42 }}>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 16, marginBottom: 22 }}>
          <h2 style={{ margin: 0, fontSize: 26, letterSpacing: '.06em', fontWeight: 500, color: '#0a1628',
            fontFamily: '"Cormorant Garamond","Shippori Mincho B1",serif' }}>HISTORY</h2>
          <span style={{ fontSize: 13, color: '#3d5070' }}>JCCの歴史</span>
        </div>
        ...
        <div style={{ marginTop: 14, fontSize: 12, color: '#3d5070', lineHeight: 1.8 }}>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 16, marginBottom: 22 }}>
          <h2 style={{ margin: 0, fontSize: 26, letterSpacing: '.06em', fontWeight: 500, color: '#0a1628',
            fontFamily: '"Cormorant Garamond","Shippori Mincho B1",serif' }}>JOIN US</h2>
          <span style={{ fontSize: 13, color: '#3d5070' }}>新入会員募集</span>
        </div>
        <div style={{ aspectRatio: '16/7', overflow: 'hidden', position: 'relative' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
